const projects = [
  ...
  },
  {
    ...
    description: "Crypto Currency Price tracker made with React, Chart.js, and the CoinGecko crypto API. Displays price information for the top 15 coins complete with a price history graph. ",
